...
namespace ADO.Consola
{
    ...
    {
        public static string StringConexion = @"Data Source=localhost\SQLEXPRESS;Database=ClaseMartesDB;Trusted_Connection=True;TrustServerCertificate=True;";
        ...
        public static List<Empleado> ListarEmpleados()
        {
            Conexion = new SqlConnection(StringConexion);
            Conexion.Open();
            SqlCommand sentencia = new SqlCommand("select Id, FirstName,  lastname from Employees", Conexion);
        ...
        public static List<string> TopTenProductosCaros()
        {
            Conexion = new SqlConnection(StringConexion);
            Conexion.Open();
            SqlCommand sentencia = new SqlCommand("TenMostExpensiveProducts", Conexion);
            //en storesprocedures necesito agregar commandType
            sentencia.CommandType = CommandType.StoredProcedure;
            SqlDataReader datareader = null;
